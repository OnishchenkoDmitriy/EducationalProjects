...
## Practical work 6
### part 1: Откройте код приложения task2(1) и внесите следующие изменения:
 Первое:
...
### part 2. Задание на работу с рефлексией.
...
### part 3. Напишите консольное приложение по архитектурному шаблону MVC, которое:
